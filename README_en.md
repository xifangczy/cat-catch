<p align="center"> [<a href="README.md">中文</a>] | [English]

# 📑Introduction
Cat-catch SE is a resource sniffing extension, a modified version of [Cat-catch](https://github.com/xifangczy/cat-catch) that disables the "Opt-out list", making it easier to browse resources on various websites.
...
(Please note that this user documentation is not definitive and is for reference only.)
...
## Add-ons Store Installation
Will be suported soon.
...
# 📚Compatibility
Chromium kernel version 93 or above is required.
