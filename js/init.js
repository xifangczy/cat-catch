...
G.scriptList.set("catch.js", { refresh: true, world: "MAIN", name: "hook脚本(catch.js)" });
G.scriptList.set("recorder.js", { refresh: false, world: "MAIN", name: "录制脚本(recorder.js)" });
if (G.version >= 104) {
    G.scriptList.set("recorder2.js", { refresh: false, world: "ISOLATED", name: "录制脚本(recorder2.js)" });
}
